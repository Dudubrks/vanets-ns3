...
VanetRoutingExperiment::Run ()
{
  ...
  NetworkStatsMonitor(&flowHelper,flowMonitor);
  
  Simulator::Destroy ();
  
  flowMonitor->SerializeToXmlFile("DSDV(58).xml", true, true);
}
...
VanetRoutingExperiment::SetupScenario ()
{
  ...
  if (m_scenario == 1)
    ...
    {
      // Realitic vehicular trace in 4.6 km x 3.0 km suburban Zurich
      // "low density, 99 total vehicles"
      m_traceFile = "/home/luiz/mobility/mobility58.tcl";
      m_logFile = "Mobility_DSDV(58).log";
      m_mobility = 1;
      m_nNodes = 58;
      m_nodeSpeed=20;
      m_nodePause = 0;
      m_CSVfileName = "Mobility_DSDV(58).csv";
      m_CSVfileName2 = "Mobility_DSDV(58)_2.csv";
    }
}
